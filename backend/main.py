...
@media(min-width:768px){
  ...
  .step{min-height:84px;display:flex;flex-direction:row;align-items:center;justify-content:center;width:100%;gap:16px;padding:20px 28px;box-sizing:border-box;}
  .step .step-num{flex:0 0 auto;}
  .step .step-body{flex:0 1 auto;display:flex;flex-direction:column;text-align:left;}
  .step .step-body .s-title{text-align:left;}
  .step .step-body .s-desc{text-align:left;}
  .preview-kw-row{max-width:400px;margin-left:auto;margin-right:auto;}
}
