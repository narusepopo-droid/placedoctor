...
@media(min-width:768px){
  ...
  .step{min-height:84px;display:flex;flex-direction:row;align-items:center;justify-content:flex-start;width:100%;gap:18px;padding:20px 32px 20px 10rem;box-sizing:border-box;}
  .preview-kw{margin-left:140px;margin-right:140px;}
