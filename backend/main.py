...
.cta-btn{display:inline-block;background:#FEE500;color:#1A1A1A;font-weight:800;font-size:15px;padding:14px 32px;border-radius:12px;text-decoration:none;margin-bottom:12px;border:none;cursor:pointer;}
