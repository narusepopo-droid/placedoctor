...
@media(min-width:768px){
  ...
  .step{min-height:88px;display:flex;flex-direction:row;align-items:center;justify-content:flex-start;width:100%;gap:18px;padding:20px 28px;box-sizing:border-box;}
