...
def generate_keywords(store_name, category, address, menu_items, official_keywords,
    ...
    _GU_TO_LOCATIONS = {
        ...
        "동대문구": ["동대문"],
        "노원구": ["노원"],
        # 서울 외 (사용자 지정 · 2026-07-11) — 구-전체로 검색 통용되는 곳만
        "해운대구": ["해운대"],           # 부산
        "부평구": ["부평"], "계양구": ["계양"], "연수구": ["연수"], "미추홀구": ["미추홀"],  # 인천
        "분당구": ["분당"], "수지구": ["수지"], "기흥구": ["기흥"], "영통구": ["영통"],       # 경기
        "일산동구": ["일산"], "일산서구": ["일산"],                                          # 고양 일산(동/서구 둘 다)
    }
